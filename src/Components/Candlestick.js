...
class Candlestick extends Component {
  ...
  yaxis: 'y'
        ...
        layout={ {width: 750, height: 520, title: 'Candlestick Plot'} }
      />
      <table id="data" class="table table-bordered">
        ...
        <tr>
            <th> Title </th>
            <td> Candlestick Plot </td>
          </tr>
          <tr>
            <th> Description</th>  
            <td> Usually focussed on day-to-day activity, these charts show opening/closing and high/low points of each day.  </td>
          </tr>
          <tr>
            <th> Type </th>
            <td> Scattered </td>
          ...
          <tr>
            <th> Data </th>
            <td> 
            <tr> x: ['2017-01-04', '2017-01-05', '2017-01-06', '2017-01-09', '2017-01-10', '2017-01-11', '2017-01-12', '2017-01-13', '2017-01-17', '2017-01-18', '2017-01-19', '2017-01-20', '2017-01-23', '2017-01-24', '2017-01-25', '2017-01-26', '2017-01-27', '2017-01-30', '2017-01-31', '2017-02-01', '2017-02-02', '2017-02-03', '2017-02-06', '2017-02-07', '2017-02-08', '2017-02-09', '2017-02-10', '2017-02-13', '2017-02-14', '2017-02-15']
            </tr> 
             <tr> y: [1,3,7,6]
              </tr>
             </td>
